...
`Cervical Spine`, `Seizure Activity`, and `Opioid Overdose`.
...
`Nausea Vomiting`, `Blood Pressure`, `Cervical Spine`, `Seizure Activity` et
`Opioid Overdose`.
...
`Blood Pressure`, `Cervical Spine`, `Seizure Activity` e `Opioid Overdose`.
