...
`Chief Complaint`, `On Arrival`, `Altered Mental Status`, `Nausea Vomiting`,
`Substance Abuse`, `Heart Transplant`, `Seizure Activity`, and `Opioid Overdose`.
...
como `Chief Complaint`, `On Arrival`, `Altered Mental Status`,
